...
import '../../../getfoodfeed/presentation/pages/index.dart';
import '../provider/getregisteredId.dart';
...
class _addAddressperState extends State<addAddressper> {
  ...
  void deactivate() {
    ...
    super.deactivate();
    context.read<GetregisteredIdprovider>().disposeint();
  }

  checkregistered() {
    setState(() {
      token = Provider.of<GetregisteredIdprovider>(context, listen: false)
          .tokenregistered;
    });
    if (token == null) {
      setState(() {
        initialname =
            Provider.of<GetIdprovider>(context, listen: false).notloggedname;
      });
    } else {
      initialname =
          '${Provider.of<GetregisteredIdprovider>(context, listen: false).firstname} ${Provider.of<GetregisteredIdprovider>(context, listen: false).lastname}';
    }
  }
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        initialValue: context
                                    .watch<GetregisteredIdprovider>()
                                    .tokenregistered ==
                                null
                            ? context.watch<GetIdprovider>().notloggednumber
                            : context.watch<GetregisteredIdprovider>().phone,
                      ...
                      TextFormField(
                        ...
                        initialValue: token == null
                            ? context.watch<GetIdprovider>().notloggedaddress
                            : context.watch<GetregisteredIdprovider>().address,
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(),
                            Consumer<GetregisteredIdprovider>(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    if (_key4.currentState!.validate()) {
                                      if (Provider.of<GetregisteredIdprovider>(
                                                  context,
                                                  listen: false)
                                              .index ==
                                          0) {
                                        ...
                                        if (token != null) {
                                          ...
                                          final changeprovider =
                                              context.read<ChangeAddressPro>();

                                          if (changeprovider.error == false) {
                                            ScaffoldMessenger.of(context)
                                                .showSnackBar(SnackBar(
                                              content: CustomeSnackbar(
                                                topic: 'Great!',
                                                msg: changeprovider.msg,
                                          ...
                                          context.read<GetIdprovider>().saveaddress(
                                              addressget().trim(),
                                              emailget().trim(),
                                              phoneget().trim(),
                                              nameget().trim(),
  ...
  Container picknetwork(BuildContext context, int index) {
    final isSeleted =
        this.context.read<GetregisteredIdprovider>().index == index;
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Radio(
            ...
            groupValue: context.watch<GetregisteredIdprovider>().group,
            onChanged: (value) {
              context.read<GetregisteredIdprovider>().showindex(value);
            },
          ),
        ],
      ),
      ...
      child: StatefulBuilder(
        builder: (context, setState) => CupertinoPicker(
          ...
          onSelectedItemChanged: (index) {
            context.read<GetregisteredIdprovider>().showindex(index);
            setState(() {
              this.index = index;
            });
          },
