...
import '../../../Firstcheck/presentation/widgets/button.dart';
import '../provider/getregisteredId.dart';
import 'addnewperaddress.dart';
...
class _AccountState extends State<Account> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: context.watch<GetregisteredIdprovider>().tokenregistered != null
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Stack(
                                          children: [
                                            Text(
                                              'Referal Code: ${context.watch<GetregisteredIdprovider>().referal}',
                                        ...
                                        Text(
                                          'Members Refered: ${context.watch<GetregisteredIdprovider>().numberrefer.toString()}',
                                          style: TextStyle(fontSize: 12),
                                        )
                                      ],
                                    ),
                                      ...
                                      Container(
                                          ...
                                          child: Text(
                                            context
                                                        ...
                                                        .firstname !=
                                                    ''
                                                ? '${context.watch<GetregisteredIdprovider>().firstname.capitalize()} ${context.watch<GetregisteredIdprovider>().lastname.capitalize()}'
                                                : '',
