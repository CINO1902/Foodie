...
class _OrderState extends State<Order> {
    ...
    _controller = ScrollController()
      ..addListener(() {
        if (_controller.position.maxScrollExtent ==
          ...
          context.read<GetOrderPro>().loadmore();
        }
      });
  }

  Future loadList() async {
    await context.read<GetOrderPro>().getorder();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          context.watch<GetregisteredIdprovider>().tokenregistered != null
              ? InkWell(
                  onTap: () {
                    setState(() {
                      _visible = !_visible;
      ...
      body: Stack(
        children: [
          Container(
            child: Consumer<GetOrderPro>(builder: (context, value, child) {
                        ...
                        Expanded(
                          child: GroupedListView<Pagnited, DateTime>(
                              ...
                              indexedItemBuilder:
                                ...
                                return index.specialName == null
                                    ? Cartbox(context, index, indexed)
                                    : Cartbox2(context, index, indexed);
                              }),
                        ),
                        context.watch<GetOrderPro>().isloadmore == true
                            ? Padding(
                            ...
                            : Container(),
                        context.watch<GetOrderPro>().hasnextpage == false
                            ? Padding(
                                padding:
              ...
              child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          context.read<GetOrderPro>().getindex(index);
                          setState(() {
                            _visible = false;
                          });
                          context.read<GetOrderPro>().clearresult();
  ...
  Future<dynamic> modalpopup(
    ...
    return showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          DateTime? currentdate = context.watch<GetTimePro>().date;
        ...
        children: [
          ...
          Row(
            children: [
              InkWell(
                onTap: () {
                  modalpopup2(context, value.image, value.multiple, value.food,
                      value.sides, value.amount, value.total, value, indexx);
                },
                child: Stack(
                  children: [
                    Row(
  ...
  Future<dynamic> modalpopup2(BuildContext context, image, multiple, food,
      extra, amount, total, Pagnited value, indexx) {
    return showModalBottomSheet(
        context: context,
        ...
        builder: (BuildContext context) {
          ...
          if ((currentday - day) == 0) {
            ...
            time1 =
                '${value.date.day}, ${months[value.date.month - 1]} ${value.date.year}';
          } else {
            time1 =
                '${value.date.day}, ${months[value.date.month - 1]} ${value.date.year}';
          }
