...
import '../../../addTocart/presentation/provider/AddTocart.dart';

import '../provider/calculate.dart';
import '../provider/getExtraprovider.dart';
...
class _ReviewState extends State<Review> {
  ...
  void deactivate() {
    ...
    super.deactivate();
    // context.read<GetExtraprovider>().cancelresquest();
          ...
          child:
            ...
            Expanded(
              child: Container(
                ...
                child: Consumer<GetExtraprovider>(
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              await context.read<GetExtraprovider>().getExtra(
                                  Provider.of<calculatemeal>(context,
                                          listen: false)
                                      .clickedfood[4]);
                            },
                    ...
                    return RefreshWidget(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final remains = value.items[index].remaining;
                            return Container(
                                child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        remains
                                            ? Text(
                                                'Remaining: ${value.items[index].remainingInt}',
                                                style: TextStyle(
                                                    fontSize: 14,
                                                    color: Colors.red),
                                                textAlign: TextAlign.center,
