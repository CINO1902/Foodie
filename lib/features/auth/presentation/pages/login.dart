...
class _loginState extends State<login> {
  ...
  Widget build(BuildContext context) {
    final authProvider = AuthProvider(locator());
  ...
  _sendToServer(AuthProvider authprovider) async {
    if (_key1.currentState!.validate()) {
      ...
      } else if ((authprovider.error == false)) {
