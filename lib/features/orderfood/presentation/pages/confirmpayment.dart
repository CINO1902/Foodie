...
import '../../../userdetails/presentation/pages/addaddress.dart';
...
class _confirmorderState extends State<confirmorder> {
  ...
  //             ? add = context.watch<GetCartPro>().address
  //             : add = context.watch<checkcart>().address
  //         : Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = '${context.watch<GetCartPro>().notloggedaddress}'
  //             : add = context.watch<checkcart>().address;
  //     return add;
  //   }
  ...
  //     token != null
  //         ? Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = context.watch<GetCartPro>().phone
  //             : add = context.watch<checkcart>().number
  //         : Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = '${context.watch<GetCartPro>().notloggednumber}'
  //             : add = context.watch<checkcart>().number;
  //     return add;
  //   }
  ...
  //         ? Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add =
  //                 '${context.watch<GetCartPro>().firstname} ${context.watch<GetCartPro>().lastname}'
  //             : add = context.watch<checkcart>().fullname
  //         : Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = '${context.watch<GetCartPro>().notloggedname}'
  //             : add = context.watch<checkcart>().fullname;
  //     return add;
  //   }
  ...
  //     token != null
  //         ? Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = context.watch<GetCartPro>().location
  //             : add = context.watch<checkcart>().location
  //         : Provider.of<checkcart>(context, listen: false).usedefault
  //             ? add = '${context.watch<GetCartPro>().notloggedlocation ?? ''}'
  //             : add = context.watch<checkcart>().location;
  //     return add;
  //   }
  ...
  void initState() {
    ...
    context.read<GetCartPro>().locationa();
    context.read<GetCartPro>().disposediscount();
  }
          ...
          Padding(
            ...
            child: ListView(children: [
              InkWell(
                onTap: () {
                  if (token == null) {
                    context.read<GetCartPro>().notloggedname == ''
                        ? Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    context.read<GetCartPro>().address == ''
                        ? Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => addAddressper()))
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        child: Expanded(
                            child: context.watch<GetCartPro>().notloggedname ==
                                        '' &&
                                    token == null
                                ? const Center(
                                    child: Text(
                                ...
                                : ListView(
                                    ...
                                    children: [
                                      Text(
                                        token != null
                                            ? Provider.of<GetregisteredIdprovider>(
                                                        context,
                                                        listen: false)
                                                    .usedefault
                                                ? '${context.watch<GetregisteredIdprovider>().firstname} ${context.watch<GetregisteredIdprovider>().lastname}'
                                                : context
                                                    .watch<GetIdprovider>()
                                                    .fullname
                                            : Provider.of<GetIdprovider>(
                                                        context,
                                                        listen: false)
                                                    .usedefault
                                                ? '${context.watch<GetCartPro>().notloggedname}'
                                                : context
                                                    .watch<GetIdprovider>()
                                                    .fullname,
                                      ...
                                      Text(
                                        token != null
                                            ...
                                            : Provider.of<GetIdprovider>(
                                                        ...
                                                        listen: false)
                                                    .usedefault
                                                ? '${context.watch<GetCartPro>().notloggednumber}'
                                                : context
                                                    .watch<GetIdprovider>()
                                                    .number,
                                        style: TextStyle(
                                        ...
                                        token != null
                                            ? Provider.of<GetregisteredIdprovider>(
                                                ...
                                                : context
                                                    .watch<GetCartPro>()
                                                    .email
                                            : Provider.of<GetCartPro>(context,
                                                        listen: false)
                                                    .usedefault
                                                ? '${context.watch<GetCartPro>().notloggedemail}'
                                                : '${context.watch<GetCartPro>().notloggedemail}',
                                        style: TextStyle(
                                          fontSize: 17,
                                        ),
                                        ...
                                        child: Text(
                                          token != null
                                              ...
                                              : Provider.of<GetIdprovider>(
                                                          ...
                                                          listen: false)
                                                      .usedefault
                                                  ? '${context.watch<GetCartPro>().notloggedaddress}'
                                                  : context
                                                      .watch<GetIdprovider>()
                                                      .address,
                                          softWrap: true,
                                      ...
                                      Text(
                                        token != null
                                            ...
                                            : Provider.of<GetIdprovider>(
                                                        ...
                                                        listen: false)
                                                    .usedefault
                                                ? '${context.watch<GetCartPro>().notloggedlocation ?? ''}'
                                                : context
                                                    .watch<
                                                        GetregisteredIdprovider>()
                                                    .location,
                                        style: TextStyle(
                                          fontSize: 17,
                                        ),
              ...
              Consumer<GetCartPro>(builder: (context, value, child) {
                return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      // print(note());
                      final cart = value.cartresult[index];
                      final image = value.cartresult[index].image;
                      final multiple = value.cartresult[index].multiple;
                      final food = value.cartresult[index].food;
                      final amount = value.cartresult[index].amount;
                      final total = value.cartresult[index].total;
                      List<Extra>? extra = value.cartresult[index].extras;

                      return value.cartresult[index].specialName == null
                          ? Cartbox(
                              context,
                              value,
                              index,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                            '₦ ${context.watch<GetCartPro>().sumget.toString()}',
                            style: TextStyle(fontSize: 19))
                      ],
                    ),
                    Row(
                      ...
                      children: [
                        ...
                        context.watch<GetCartPro>().loading
                            ? CircularProgressIndicator(
                                color: Theme.of(context).primaryColor,
                              )
                            : Text(
                                '${context.watch<GetCartPro>().totalcartcall.toString()} X ₦ ${(context.watch<GetCartPro>().delivery / context.watch<GetCartPro>().totalcartcall).toString()}',
                                style: TextStyle(fontSize: 19))
                      ],
                    ),
                    Consumer<GetCartPro>(builder: (context, value, child) {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        context.watch<GetCartPro>().moneytopay < 0
                            ? Text('₦ 0.00',
                                style: TextStyle(
                                    fontSize: 21, fontWeight: FontWeight.bold))
                            : Text(
                                '₦ ${context.watch<GetCartPro>().moneytopay.toString()}',
                                style: TextStyle(
                                    fontSize: 21,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.white),
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            if (Provider.of<GetCartPro>(context, listen: false)
                                    .error ==
                                true) {
                            ...
                            } else if (Provider.of<GetCartPro>(context,
                                        listen: false)
                                    .loading ==
                                true) {
                            ...
                            } else if (context.read<GetCartPro>().address ==
                                    '' &&
                                token != null) {
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(SnackBar(
          ...
          return SizedBox(
            ...
            child: Dialog(
              ...
              child: Container(
                ...
                child: Consumer<GetCartPro>(builder: (context, value, child) {
                  return Form(
                    //key: _formKey,
                    child: Column(
  ...
  taketoweb() async {
    Future<String> getReference() async {
      await context.read<GetTimePro>().getTime();
      String platform;
      if (Platform.isIOS) {
        platform = 'iOS';
      } else {
      ...
      return 'ChargedFrom${platform}_${Provider.of<GetTimePro>(context, listen: false).date.millisecondsSinceEpoch}';
    }
    ...
    // await createref(
    //     token != null
    //         ? Provider.of<GetCartPro>(context, listen: false).email
    //         : '${Provider.of<GetIdprovider>(context, listen: false).id}',
    //     ref);
    ...
    if (success == 'success') {
      ...
      //               email: token != null
      //                   ? Provider.of<GetCartPro>(context, listen: false).email
      //                   : '${Provider.of<GetCartPro>(context, listen: false).notloggedemail}',
      //               price: (Provider.of<GetCartPro>(context, listen: false)
      //                       .moneytopay)
      //                   .round()
      //                   .toString(),
      //               ID: token != null
      //                   ? Provider.of<GetCartPro>(context, listen: false).email
      //                   : '${Provider.of<GetCartPro>(context, listen: false).ID}',
      //               ref: ref,
      //               ordernum: ordernum,
      //               type: 'quickbuycheck',
      //             )),
  ...
  Widget Cartbox(BuildContext context, GetCartPro value, int indexx, cart,
      image, multiple, food, extra, amount, total, cartresults) {
  ...
  Widget Cartbox2(BuildContext context, GetCartPro value, int indexx, cart,
  ...
  whatsapp(ordernum) async {
    var contact =
        Provider.of<GetCartPro>(context, listen: false).whatsappnumber;
    var androidUrl =
